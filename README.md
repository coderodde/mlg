...
***mlg*** is a Java framework providing for **6** different algorithms for minimizing the amount of nodes. 3 of them are experimental (they work and correctly, but are not most efficient):
