...
***mlg*** is a Java framework providing for **9** different algorithms for minimizing the amount of arcs, 5 of them are experimental (they work and correctly, but are not most efficient):
